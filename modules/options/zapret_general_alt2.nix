{
  ...
  cfg = config.zapret_general_alt2;
in {
  options.zapret_general_alt2 = {
  ...
  config = lib.mkIf cfg.enable {
    services.zapret = {
      ...
      params = [
        ...
        "--dpi-desync-split-seqovl-pattern=${inputs.secret_files.packages.${pkgs.system}.files}/tls_clienthello_www_google_com.bin"
      ];
    };
  };
}

...
**If your pc too low-end like Intel Core i7-6700K + GeForce GTX 680 the best thing you can do is dual-booting Windows 10, because even with my hardware setup I encounter performance issues because of CPU that just cna't handle two systems running on it.**
